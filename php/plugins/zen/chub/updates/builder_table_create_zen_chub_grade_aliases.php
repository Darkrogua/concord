...
class BuilderTableCreateZenChubGradeAliases extends Migration
{
    public function up()
    {
        Schema::create('zen_chub_grade_aliases', function($table)
        {
    ...
    {
        DB::statement('DROP TABLE IF EXISTS zen_chub_grade_aliases CASCADE');
    }
}